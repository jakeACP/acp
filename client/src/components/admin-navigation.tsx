...
const adminMenuItems = [
  { name: "Dashboard", href: "/admin/dashboard", icon: LayoutDashboard, category: "main" },
  { name: "Moderation", href: "/admin/moderation", icon: Shield, category: "content" },
  { name: "Polls", href: "/admin/polls", icon: BarChart3, category: "content" },
  { name: "AI Writer", href: "/admin/ai-parameters", icon: Cpu, category: "content" },
  { name: "Users", href: "/admin/users", icon: UserCircle, category: "people" },
  { name: "Politicians", href: "/admin/politicians", icon: Users, category: "people" },
  ...
  { name: "News Scanner", href: "/admin/scanner", icon: Radar, category: "system" },
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center overflow-x-auto">
            <div className="flex items-center gap-2 mr-4 flex-shrink-0">
              ...
              <h2 className="text-base font-bold text-slate-900 dark:text-slate-100">Admin</h2>
            </div>
          ...
          <Link
            href="/"
            className="text-xs text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 flex-shrink-0"
          >
            Back to Site
          </Link>
        </div>
