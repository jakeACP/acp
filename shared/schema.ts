...
export const users = pgTable("users", {
  ...
  role: text("role").notNull().default("citizen"), // admin, state_admin, moderator, dba, citizen, candidate
...
export const agentLogs = pgTable("agent_logs", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  apiKeyId: varchar("api_key_id").references(() => agentApiKeys.id, { onDelete: "set null" }),
  ...
  apiKeyIndex: index("agent_logs_api_key_idx").on(table.apiKeyId),
